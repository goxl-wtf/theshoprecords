...
ALTER TABLE seller_profiles 
  -- Rename shop_name to store_name (required by the code)
  RENAME COLUMN shop_name TO store_name;

-- Rename shop_description to description (required by the code)
ALTER TABLE seller_profiles 
  RENAME COLUMN shop_description TO description;
...
BEGIN
  IF NOT EXISTS (
    ...
    -- Update condition values from media_condition
